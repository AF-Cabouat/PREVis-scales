...
required_libraries <- c("psych", "mice", "mifa", "corrplot", "knitr", "tibble")
...
if (!require("misty", character.only = TRUE)) {
  ...
  warning("misty package not installed. Installing version 0.6.0 now and its dependency 'norm'.")
  warning("This process requires RTools installed on your system.")
  
  install.packages(c("norm",  "ggplot2", "lavaan", "readxl", "rstudioapi", "writexl"))
  packageurl <- "https://cran.r-project.org/src/contrib/Archive/misty/misty_0.6.0.tar.gz"
  install.packages(packageurl, repos=NULL, type="source")
  
  library("misty", character.only = TRUE)
  cat("######################################################################################")
  cat("misty package version 0.6.0 installed and loaded. You can proceed with the next chunk.")
  cat("######################################################################################")
  ...
  if (packageVersion("misty") != "0.6.0") {
    ...
    warning("Required misty version: 0.6.0. Found a different version installed:")
    print(packageVersion("misty"))
    
    cat("Uninstalling misty...")
    remove.packages("misty")
    cat("misty was successfully uninstalled.")
    ...
    if (packageVersion("misty") == "0.6.0") {
      cat("###########################################################################\n")
      cat("misty package version 0.6.0 installed. You can proceed with the next chunk.\n")
      cat("###########################################################################\n")
    }
  }
}
